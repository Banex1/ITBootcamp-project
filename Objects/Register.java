...
public class Register {
	...
	public static final String Register_URL = "https://petstore.octoperf.com/actions/Account.action?newAccountForm=";
	...
	private static final String SaveAccButton = "//input[@name='newAccount']";

	// Method to find User ID field
	public static WebElement getUserID(WebDriver driver) {
		WebElement driver1 = driver.findElement(By.xpath(User_ID));
		return driver1;
	}
	...
	// Method to input ID
	public static void inputUserID(WebDriver driver, String input) {
		getUserID(driver).sendKeys(input);
	}

	// Method to clear ID field
	public static void clearUserID(WebDriver driver) {
